...
class Trainer(ABC, Generic[T_model, T_args]):
    ...
    @abstractmethod
    def step(self, batch: Tuple[Tuple[torch.Tensor, ...], Dict[str, Any]]) -> Dict[str, float]:
        ...
    
    @abstractmethod
    def validate_step(self, batch: Tuple[Tuple[torch.Tensor, ...], Dict[str, Any]]) -> Dict[str, float]:
        ...
    ...
    def train(self, resume_from: Optional[str] = None) -> None:
        ...
        try:
            ...
            for epoch in range(self.n_epochs, self.args.epochs):
                ...
                if (self.args.unfreeze_epoch >= 0 and 
                    epoch == self.args.unfreeze_epoch):
